...
import (
	...
	nsqio "github.com/andyxning/nsq-operator/pkg/generated/informers/externalversions/nsqio"
...
func (f *sharedInformerFactory) Nsq() nsqio.Interface {
	return nsqio.New(f, f.namespace, f.tweakListOptions)
}
