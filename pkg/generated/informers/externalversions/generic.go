...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	switch resource {
	// Group=nsq.io, Version=v1alpha1
	case v1alpha1.SchemeGroupVersion.WithResource("nsqadmins"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Nsq().V1alpha1().NsqAdmins().Informer()}, nil
	case v1alpha1.SchemeGroupVersion.WithResource("nsqlookupds"):
